...
# ============================================================
    ...
    # Jedyny blok do wpisywania nazw państw.
    # Nie ma tutaj już swc_rep_name ani swc_country_name.
    ...
    with swc_tabela:
        ...
        raport_swc.append(
            f"Pogoda: "
            f"{st.session_state.get('swc_pogoda', swc_pogoda)}"
        )
        ...
        for rep in range(1, 5):
            ...
            for nr in range(1, 6):
                ...
                raport_swc.append(
                    ...
                    f"{nazwa} | "
                    f"OVR "
                    f"{st.session_state.get(f'swc_ovr_{rep}_{nr}', 60)} | "
                    f"{pkt} pkt | "
                    f"Biegi: "
